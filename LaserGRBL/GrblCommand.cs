...
namespace LaserGRBL
{
	...
	public partial class GrblCommand : ICloneable, IGrblRow
	{
		...
		public CommandStatus Status
		{
			get
			{
				...
				else if (mCodedResult.Length == 0 || mCodedResult.Contains("BUSY"))
	...
	public class GrblMessage : IGrblRow
	{
		...
		public GrblMessage(string message, bool decode)
		{
			...
			if (mMessage.ToLower().StartsWith("$") || mMessage.ToLower().StartsWith("M108") || mMessage.ToLower().StartsWith("M0") || mMessage.ToLower().StartsWith("?") || mMessage.ToLower().StartsWith("ctrl"))
