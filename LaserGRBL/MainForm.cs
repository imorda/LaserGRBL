...
namespace LaserGRBL
{
	public partial class MainForm : Form
	{
		...
		{
            Core.EnqueueCommand(new GrblCommand("G90"));
            Core.EnqueueCommand(new GrblCommand("M107 P1"));
            Core.EnqueueCommand(new GrblCommand("G28 X Y"));
            Core.EnqueueCommand(new GrblCommand("G1 F3000 X104 Y127.3"));
            Core.EnqueueCommand(new GrblCommand("G28 Z"));
            Core.EnqueueCommand(new GrblCommand("G1 F200 Z" + GrblFile.offset.ToString()));
            Core.EnqueueCommand(new GrblCommand("G1 F3000 X79 Y25"));
            Core.EnqueueCommand(new GrblCommand("G92 X0 Y0 Z0"));
            Core.EnqueueCommand(new GrblCommand("" + "M106 P1 S1"));
            Core.EnqueueCommand(new GrblCommand("G21"));
