...
namespace LaserGRBL.SvgConverter
{
	public static class gcode
	{
		...
		private static string gcodeSpindleCmd = "M106 P1"; // Spindle Command M3 / M4
        private static string gcodeSpindleCmd2 = "M107 P1"; // Spindle Command M3 / M4
		...
		public static void setup()
		{
			...
			gcodeSpindleCmd = (string)Settings.GetObject("GrayScaleConversion.Gcode.LaserOptions.LaserOn", "M106 P1");
			gcodeSpindleCmd2 = (string)Settings.GetObject("GrayScaleConversion.Gcode.LaserOptions.LaserOff", "M107 P1");
