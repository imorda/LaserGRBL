...
namespace LaserGRBL.SvgConverter
{
	...
	public partial class SvgToGCodeForm : Form
	{
        ...
        private SvgToGCodeForm(GrblCore core, string filename, bool append)
		{
            ...
            GCodeFromSVG.Offset = OffsetZ.CurrentValue;
		...
		public void ShowDialogForm(Form parent)
        {
			...
			string LaserOn = (string)Settings.GetObject("GrayScaleConversion.Gcode.LaserOptions.LaserOn", "M106 P1");
			...
			string LaserOff = (string)Settings.GetObject("GrayScaleConversion.Gcode.LaserOptions.LaserOff", "M107 P1");
